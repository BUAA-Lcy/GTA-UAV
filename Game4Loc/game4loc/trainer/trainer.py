    ...
    for batch in bar:
        ...
        if scaler:
            with autocast():
                ...
                if train_with_recon:
                    features1, features1_recon, features2, features2_recon = model(img1=query, img2=reference, pose=query_pose, forward_features=True)
                    ...
                    features1, features2 = model(img1=query, img2=reference, pose=query_pose)
